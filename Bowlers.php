...
<head>
    ...
    <title>Bowlers Selection</title>
</head>
<body>

<h2>Available Bowlers</h2>

<?php
$sql = "SELECT * FROM player WHERE Role = 'Bowler'";
        ...
        echo "<tr>
                ...
                <td>
                    <form method='POST'>
                        ...
                        <input type='hidden' name='batting_sr' value='".$row['Batting_SR']."'>
                        <input type='hidden' name='bowling_sr' value='".$row['Bowling_SR']."'>
